...
@onready var HintButtonComment: Button = $"#options_game#/GameSetting/VSplit/DataPath/HintButton"

@onready var GameLanguage: OptionButton = $"#options_game#/GameSetting/VSplit/Language/language_button"
@onready var GameLanguageRestore: Button = $"#options_game#/GameSetting/VSplit/Language/language_restore"
@onready var DataPath: Button = $"#options_game#/GameSetting/VSplit/DataPath/datapath_button"
@onready var DataPathRestore: Button = $"#options_game#/GameSetting/VSplit/DataPath/datapath_restore"
@onready var path_choose: FileDialog = $"#options_game#/GameSetting/VSplit/DataPath/datapath_button/path_choose"
@onready var UseSubThreads: CheckBox = $"#options_game#/GameSetting/VSplit/UseSubThreads/ust_checkbox"
...
@onready var PrintDebugInfo: CheckBox = $"#options_game#/GameSetting/VSplit/DebugOptContainer/PrintDebugInfo/pdi_checkbox"
@onready var PrintDebugInfoRestore: Button = $"#options_game#/GameSetting/VSplit/DebugOptContainer/PrintDebugInfo/pdi_restore"
@onready var CatchPElemIssue: CheckBox = $"#options_game#/GameSetting/VSplit/DebugOptContainer/catchPElemIssue/cpei_checkbox"
@onready var CatchPElemIssueRestore: Button = $"#options_game#/GameSetting/VSplit/DebugOptContainer/catchPElemIssue/cpei_restore"
@onready var AlwaysShowCursor: CheckBox = $"#options_game#/GameSetting/VSplit/DebugOptContainer/alwaysShowCursor/asc_checkbox"
...
@onready var Fullscreen: CheckBox = $"#options_video#/VideoSetting/VSpilt/Fullscreen/fullscreen_checkbox"
@onready var FullscreenRestore: Button = $"#options_video#/VideoSetting/VSpilt/Fullscreen/fullscreen_restore"
@onready var Scale: SpinBox = $"#options_video#/VideoSetting/VSpilt/Scale/scale_spin"
@onready var ScaleRestore: Button = $"#options_video#/VideoSetting/VSpilt/Scale/scale_restore"
@onready var Sdfgi: CheckBox = $"#options_video#/VideoSetting/VSpilt/SDFGI/sdfgi_checkbox"
@onready var SdfgiRestore: Button = $"#options_video#/VideoSetting/VSpilt/SDFGI/sdfgi_restore"

@onready var MasterVolume: HSlider = $"#options_audio#/AudioSetting/VSpilt/Master/master_slider"
@onready var MasterVolumeRestore: Button = $"#options_audio#/AudioSetting/VSpilt/Master/master_restore"
@onready var MasterVolumePercent: Label = $"#options_audio#/AudioSetting/VSpilt/Master/master_percent"
@onready var BgmVolume: HSlider = $"#options_audio#/AudioSetting/VSpilt/Music/bgm_slider"
@onready var BgmVolumeRestore: Button = $"#options_audio#/AudioSetting/VSpilt/Music/bgm_restore"
@onready var BgmVolumePercent: Label = $"#options_audio#/AudioSetting/VSpilt/Music/bgm_percent"
@onready var SfxVolume: HSlider = $"#options_audio#/AudioSetting/VSpilt/SFX/sfx_slider"
@onready var SfxVolumeRestore: Button = $"#options_audio#/AudioSetting/VSpilt/SFX/sfx_restore"
@onready var SfxVolumePercent: Label = $"#options_audio#/AudioSetting/VSpilt/SFX/sfx_percent"

@onready var MouseSen: HSlider = $"#options_control#/ControlSetting/VSpilt/MouseSen/mouse_slider"
@onready var MouseSenRestore: Button = $"#options_control#/ControlSetting/VSpilt/MouseSen/mouse_restore"
@onready var MouseSenPercent: Label = $"#options_control#/ControlSetting/VSpilt/MouseSen/mouse_percent"
@onready var AutoPickup: CheckBox = $"#options_control#/ControlSetting/VSpilt/AutoPickup/auto_pickup_checkbox"
